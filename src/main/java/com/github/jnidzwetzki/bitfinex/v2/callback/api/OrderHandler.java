...
public class OrderHandler implements APICallbackHandler {
	...
	private void handleOrderCallback(BitfinexApiBroker bitfinexApiBroker, final JSONArray order) throws APIException {		
		...
		exchangeOrder.setPrice(order.optBigDecimal(16, null));
		exchangeOrder.setPriceAvg(order.optBigDecimal(17, null));
		exchangeOrder.setPriceTrailing(order.optBigDecimal(18, null));
		exchangeOrder.setPriceAuxLimit(order.optBigDecimal(19, null));
